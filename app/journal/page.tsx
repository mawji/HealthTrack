  ...
  return (
    <main className="page">
      <header className="rise rise-1" style={{ marginBottom: 14 }}>
        ...
        <p className="page-sub">Everything you've logged by hand — weight, glucose, temperature, body fat, sleep.</p>
      </header>
  ...
  return (
    <section className="card stack" style={{ gap: 12 }}>
      ...
      <div className="row" style={{ gap: 8 }}>
        <input className="field" type="number" inputMode="decimal" step="0.1" value={value} onChange={(e) => setValue(e.target.value)} style={{ flex: 1 }} />
        {isSleep ? (
